...
if(isset($_SESSION['user'])) {
    ...
    if(isset($_POST['id_userForm'],$_POST['primeiro_nomeForm'],$_POST['ultimo_nomeForm'], $_POST['emailForm'],$_POST['textareaForm'], $_POST['letraForm'], $_POST['corForm'])){
        ...
        $query = "INSERT INTO escritores (id_user, primeiro_nome, ultimo_nome, email, sobre_mim, letra_id, cor_id) VALUES ($id_user, '$primeiro_nome', '$ultimo_nome', '$email', '$textarea', $letra_id, $cor_id)";
        if($stmt = @mysqli_query($dbc, $query)) {
